...
<html lang="en">
	<head>
		...
		<!-- nouislider -->
		<link type="text/css" rel="stylesheet" href="{{asset('guest/css/nouislider.min.css')}}"/>
		<!-- Font Awesome Icon -->
		<link rel="stylesheet" href="{{asset('guest/css/font-awesome.min.css')}}">
		<!-- Custom stlylesheet -->
		<link type="text/css" rel="stylesheet" href="{{asset('guest/css/style.css')}}"/>
	...
	<body>
		...
		<script src="{{asset('guest/js/nouislider.min.js')}}"></script>
		<script src="{{asset('guest/js/jquery.zoom.min.js')}}"></script>
